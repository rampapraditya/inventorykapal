    ...
    public function exportexcel() {
        if (session()->get("logged_in")) {
            ...
            if($cek1 > 0 && $cek2 > 0){
                ...
                $nama_kapal = $this->model->getAllQR("select nama_kapal from kapal where idkapal = '".$kapal."';")->nama_kapal;
    ...
    public function cetak() {
        if (session()->get("logged_in")) {
            ...
            if($cek1 > 0 && $cek2 > 0){
                ...
                $dompdf->loadHtml(view('barang/pdf', $data));
