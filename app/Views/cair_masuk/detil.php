<script type="text/javascript">
    ...
    $(document).ready(function () {
        table = $('#tb').DataTable({
            ajax: "<?php echo base_url(); ?>/logmasukcair/ajaxdetil/<?php echo $kode; ?>",
            ordering: false
        });
    });
    ...
    function showBarang(){
        ...
        $.ajax({
            url: "<?php echo base_url(); ?>/logmasukcair/loadtable/" + kode,
            type: "POST",
            dataType: "JSON",
    ...
    function save() {
        ...
        var jumlah_minta = document.getElementById('jumlah_minta').value;
        var jumlah_datang = document.getElementById('jumlah_datang').value;
        ...
        if (kode === "") {
        ...
        }else if(jumlah_minta === ""){
            alert("Jumlah permintaan tidak boleh kosong");
        }else if(jumlah_datang === ""){
            alert("Jumlah pemenuhan tidak boleh kosong");
        }else if(satuan === ""){
            ...
            var url = "";
            if (save_method === 'add') {
                url = "<?php echo base_url(); ?>/logmasukcair/ajax_add";
            } else {
                url = "<?php echo base_url(); ?>/logmasukcair/ajax_edit";
            }
            ...
            form_data.append('jumlah_minta', jumlah_minta);
            form_data.append('jumlah_datang', jumlah_datang);
    ...
    function hapus(id, nama) {
        if (confirm("Apakah anda yakin menghapus barang nomor " + nama + " ?")) {
            $.ajax({
                url: "<?php echo base_url(); ?>/logmasukcair/hapusdetil/" + id,
                type: "POST",
                dataType: "JSON",
                success: function (data) {
                    alert(data.status);
    ...
    function save_file(){
        ...
        $.ajax({
            url: "<?php echo base_url(); ?>/logmasukcair/uploadmasuk",
            dataType: 'JSON',
            cache: false,
            contentType: false,
            processData: false,
...
<div class="content-wrapper">
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">TRANSAKSI LOGISTIK CAIR MASUK (<?php echo $ket; ?>)</h4>
                </div>
                <div class="card-body">
            ...
            <div class="modal-body">
                <form id="form" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <input id="jumlah_minta" name="jumlah_minta" class="form-control" type="text" autocomplete="off" onkeypress="return hanyaAngka(event,false);">
                    </div>
                    <div class="form-group">
                        <label>JUMLAH PEMENUHAN</label>
                        <input id="jumlah_datang" name="jumlah_datang" class="form-control" type="text" autocomplete="off" onkeypress="return hanyaAngka(event,false);">
                    </div>
                    <div class="form-group">
                        <label>SATUAN</label>
