<script type="text/javascript">
    ...
    function load_tb_platform(){
        tb_platform = $('#tb_platform').DataTable({
            ajax: "<?php echo base_url(); ?>/brgmasuk/ajax_platform",
            ordering: false,
            retrieve:true
        });
        tb_platform.destroy();
    ...
    function load_tb_sewaco(){
        tb_sewaco = $('#tb_sewaco').DataTable({
            ajax: "<?php echo base_url(); ?>/brgmasuk/ajax_sewaco",
            ordering: false,
            retrieve:true
        });
        tb_sewaco.destroy();
    ...
    function load_tb_komaliwan(){
        tb_komaliwan = $('#tb_komaliwan').DataTable({
            ajax: "<?php echo base_url(); ?>/brgmasuk/ajax_komaliwan",
            ordering: false,
            retrieve:true
        });
    ...
    function load_tb_br_umum(){
        tb_br_umum = $('#tb_br_umum').DataTable({
            ajax: "<?php echo base_url(); ?>/brgmasuk/ajax_br_umum",
            ordering: false,
            retrieve:true
        });
        tb_br_umum.destroy();
